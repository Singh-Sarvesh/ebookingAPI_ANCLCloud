...
{
    public class GetBookingIDDataController : ApiController
    {
        ...
        public Dictionary<string, object> Post(BookingDetail objbookingDetail)
        {
            ...
            try
            {
                ...
                strXml += "<ebooking><actionname>openlocalroid</actionname><roid>" + objbookingDetail.BookingID + "</roid>"
                ...
                else
                {
                    ...
                    if (objdt.Rows.Count > 0)
                    {
                        foreach (DataRow dr in objdt.Rows)
                        {
                            ...
                            objOpenOder.RevisionNumber = Convert.ToInt16(dr["RevisionNumber"]);
                            objOpenOder.LocalROID = Convert.ToInt64(dr["LocalROID"]);
                            objOpenOder.CloudOrderStatus = Convert.ToInt16(dr["CloudOrderStatus"]);
