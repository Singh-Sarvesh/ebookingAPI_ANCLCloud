                ...
                if (selecteddate.Length > 0)
                {
                    strXml += "<ebooking>"
                       + "<orderlevel>"
                               ...
                               + "<revisionnumber>" + objbookingDetail.RevisionNumber + "</revisionnumber>"
                               + "<localroid>" + objbookingDetail.LocalROID + "</localroid>"
                               + "<cloudorderstatus>" + objbookingDetail.CloudOrderStatus + "</cloudorderstatus>";
                    ...
                    for (var i = 0; i < totalrecordreturn; i++)   // selecteddate.Length
                    {
                        ...
                        //if (objbookingDetail.IsCD == 0 && objbookingDetail.list[i].TotalWords != "0")
                        //{
                            strXml += "<mbodychanged>" + objbookingDetail.MBodyChange + "</mbodychanged>"
                                 + "<bodycount>" + objbookingDetail.list[i].TotalWords + "</bodycount>"
                        ...
                        //        + "<footertext></footertext>";
                        //}
                        strXml += "<materialtype>" + objbookingDetail.MaterialType + "</materialtype>"
                        ...
                        //}
                        strXml += "<boxnumber>" + objbookingDetail.list[i].BoxNumber + "</boxnumber>"
